...
# import library, first things first.
import random



# Define the functions
# Define the print instruction function
...
# define the print choices menu function
def print_choices():
    print("""       
...
# define the get the player's choice as an input function
...
def main():
    ...
    # Oasis - you have a 1 in 20 chance of finding it
